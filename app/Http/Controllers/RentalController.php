...
class RentalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('rental.index', compact('mobil', 'sopir', 'pengguna', 'manager', 'rental'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect(url('rental/'))->with('error', $ex->getMessage());
        }
        return redirect(url('rental/'))->with('success', 'Data Berhasil Ditambahkan !');
    }
